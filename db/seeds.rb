...
# Major.create(name: "철학과" )
#
# Locker.create(limit_num: 100, major_id: 1)
# Locker.create(limit_num: 100, major_id: 2)
# User.create(username: "운영자", name: "운영자", email: 'antmgu@naver.com', password: "12341234", password_confirmation: "12341234", role: "슈퍼관리자", major_id: 1, certification: true)
...
# User.create(username: "Enactus", name: "Enactus", email: '1asd@1asd.com', password: "encatus123", password_confirmation: "encatus123", role: "인액터스", major_id: 1, certification: true)
#
# require 'csv'
# require 'open-uri'
# #iba 명단
# csv_text = File.read("#{Rails.root}/db/iba.csv")
# csv = CSV.parse(csv_text, :headers => true)
# csv.each_with_index do |row, index|
#   saving = User.create!(row.to_hash)
#   saving.update!(role: "학생", email: "#{saving.id}#{index}@#{index}.com", major_id: 1, certification: true)
# end
#
# # 인액터스 데이터 가져오기
...
#
# # 죽전 csv
# csv_text = File.read("#{Rails.root}/db/juck.csv")
# csv = CSV.parse(csv_text, :headers => true)
# csv.each do |row|
