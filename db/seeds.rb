...
#
# # BestLectureInfo.create(l_type: "전공선택")
# # BestLectureInfo.create(l_type: "전공필수")
# # BestLectureInfo.create(l_type: "학부기초")
# BestFive.create(category: "교양")
# RehearsalLecture.create(name: "멋쟁이 사자처럼", ldate: "[사이버]", lnum: "32400", limit_num: 1, teacher: "이두희", score: 3, divide: 2)
# RehearsalLecture.create(name: "루비 온 레일즈", ldate: "월 11,12,13,14", lnum: "123343", limit_num: 2, teacher: "문승현", score: 3, divide: 3)
# RehearsalLecture.create(name: "경영학원론", ldate: "수 11,12,13,14", lnum: "32400", limit_num: 55, teacher: "빌게이츠", score: 3, divide: 2)
...
#
Book.create(name:'어린왕자', price: 13000, bgiver: "문승현")
Book.create(name:'어린왕자', price: 10000, bgiver: "고영일")
Book.create(name:'어린왕자', price: 5000, bgiver: "김순후")
Book.create(name:'불멸', price: 13000, bgiver: "문승현")
Book.create(name:'불멸', price: 10000, bgiver: "고영일")
Book.create(name:'불멸', price: 5000, bgiver: "김순후")
Book.create(name:'원피스', price: 13000, bgiver: "문승현")
Book.create(name:'원피스', price: 10000, bgiver: "고영일")
Book.create(name:'원피스', price: 5000, bgiver: "김순후")
