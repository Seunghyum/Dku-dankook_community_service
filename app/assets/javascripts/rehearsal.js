...
$(document).ready(function(){
  $(".clickable").click(function(){
    if($(this).hasClass("on")){
      ...
      $("#sucess-list").prepend('<tr id="click_list' + class_id + '"><td scope="rowgroup" rowspan="2" class="bg_striped"><div class="f_r" id="div_btn" style="padding:3px 0px 3px 0px"><button type="button" id="potepolPopBtn" name="potepolPopBtn" class="btn btn_ctr" data-userauth="true" data-enabled="true"><span class="btn_txt">삭제</span></button></div></td><td>죽전</td><td>' + lnum + '</td><td>2</td><td>' + lname  +  '</td><td>3</td><td>' + teacher + '</td><td></td></tr><tr class="tr-1"><th colspan="7"><div class="ta_l" style="margin-left: 20px;">' + ldate + '</div></th></tr>');
      $(this).addClass("on");
      deleteClick();
    }
  });
